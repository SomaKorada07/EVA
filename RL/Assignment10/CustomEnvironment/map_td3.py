...
class Car(Widget):
    ...
    def move(self, rotation):
        ...
        # y_coord2 = int(self.y)+40 if self.y < 610 else 650
...
class Game(Widget):
    ...
    #max_episodes = 100 #int(1e8)  # max num of episodes
    eval_episode = 1
    ...
    def reset(self):
        ...
        self.car.x = np.random.randint(100, 1400) #np.random.uniform(100, 1400, (1,))
        self.car.y = np.random.randint(100, 600)
